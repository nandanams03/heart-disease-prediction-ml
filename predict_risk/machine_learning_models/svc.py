...
classifier = SVC(kernel = 'rbf', random_state = 3 ,probability=True)
classifier.fit(X_train, Y_train)
import joblib

filename = 'C:/Users/rupak dey/Desktop/Heart-disease-prediction-master/Heart-disease-prediction-master/predict_risk/production/svc_model.pkl'
